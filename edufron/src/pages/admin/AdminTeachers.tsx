...
import { Plus, Search, Edit, Trash2, Mail, Phone, GraduationCap } from "lucide-react";
      ...
      <div className="space-y-6">
          ...
          <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[525px]">
              <DialogHeader>
                ...
                <DialogDescription>
                  {editingTeacher ? "Update the teacher information below." : "Fill in the details to add a new teacher."}
                </DialogDescription>
              </DialogHeader>
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <FormField control={form.control} name="email" render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl><Input type="email" placeholder="sarah@example.com" {...field} /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                  </div>
                  ...
                  <FormField control={form.control} name="qualification" render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl><Input placeholder="PhD in Mathematics, MIT" {...field} /></FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />
                  ...
                  <FormField control={form.control} name="experience" render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl><Input placeholder="8 years" {...field} /></FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />
                  ...
                  <FormField control={form.control} name="bio" render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea placeholder="Brief description of the teacher's background and expertise..." className="resize-none" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex gap-2">
            <Badge variant="outline" className="text-sm">Total: {teachers.length} teachers</Badge>
          </div>
        </div>
                  ...
                  <TableRow key={teacher.id}>
                    <TableCell>
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground line-clamp-1">{teacher.qualification}</div>
                        </div>
                      </div>
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      <div className="flex space-x-2">
                        ...
                        <Button variant="ghost" size="sm" onClick={() => handleDelete(teacher.id)} className="text-destructive hover:text-destructive">
