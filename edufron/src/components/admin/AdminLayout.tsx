            ...
            <div className="flex items-center space-x-4">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" size="sm" className="relative h-10 w-10 rounded-full bg-gray-100 hover:bg-gray-200 text-black flex items-center justify-center">
                ...
                <DropdownMenuContent align="end" className="w-80 bg-white text-black">
                  ...
                  <DropdownMenuItem>
                    <div className="flex flex-col space-y-1">
                      ...
                      <p className="text-xs text-gray-500">Sarah Smith applied for Physics position</p>
                    </div>
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
